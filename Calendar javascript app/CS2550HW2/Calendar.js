...
function calendar()
{
        ...
        CurrMonthNumDays = DaysPerMonth[currMonth];
        //create title for month

        var monthYearLabel = ListOfMonths[currMonth]+' '+currYear;
        firstDayMonth = currDate;
        firstDayMonth.setDate(1);
        firstDayMonth = firstDayMonth.getDay();
        var HTML = "<table border=0 width=100%><tr>";
        HTML += '<table class="main_calendar" onload="document.getElementById(\'calendar_title\');"><tbody id="calendar_title"><tr><th colspan="7">'+monthYearLabel+'</th></tr>';
